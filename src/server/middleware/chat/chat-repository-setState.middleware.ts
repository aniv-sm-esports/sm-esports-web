...
export class ChatRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{chatRoomId:number}, ApiResponse<Chat>, ApiRequest<Chat>, ParsedQs, Record<string, any>>, response: Response<any, Record<string, any>, number>, next: any) {
    // TODO
  }
}
