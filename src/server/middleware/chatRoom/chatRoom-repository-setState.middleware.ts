...
export class ChatRoomRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public apply(request: Request<{}, ApiResponse<ChatRoom>, ApiRequest<ChatRoom>, ParsedQs, Record<string, any>>,
    ...
    //(this.controllerManagerService.getPrimaryController(ChatRoomControllerName) as ChatRoomController).setState(request, response);
  }
}
