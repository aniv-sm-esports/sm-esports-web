...
export class ChatGroupGetAllMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroup>, ApiRequest<ChatGroup>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatGroupControllerName) as ChatGroupController).getAll(request, response);
  }
}
