...
export class ChatGroupRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroup>, ApiRequest<ChatGroup>, ParsedQs, Record<string, any>>,
    ...
    //(this.controllerManagerService.getPrimaryController(ChatGroupControllerName) as ChatGroupController).setState(request, response);
  }
}
