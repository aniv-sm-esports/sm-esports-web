...
import {ChatCategoryGroupMapControllerName, ChatGroupControllerName} from '../../service/controller-const';
...
export class ChatGroupCreateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroup>, ApiRequest<ChatGroup>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatGroupControllerName) as ChatGroupController).create(request, response);
  }
}
