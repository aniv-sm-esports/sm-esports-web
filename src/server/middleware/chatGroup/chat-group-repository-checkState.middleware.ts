...
import {ChatGroupControllerName, ChatRoomControllerName} from '../../service/controller-const';
...
export class ChatGroupRepositoryCheckStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroup>, ApiRequest<ChatGroup>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatGroupControllerName) as ChatGroupController).checkState(request, response);
  }
}
