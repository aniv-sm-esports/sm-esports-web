...
export class UserRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<User>, ApiRequest<User>, ParsedQs, Record<string, any>>, response: Response<any, Record<string, any>, number>, next: any) {
    //(this.controllerManagerService.getPrimaryController(UserControllerName) as UserController).setState(request, response);
  }
}
