...
export class UserGetMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<User>, ApiRequest<User>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(UserControllerName) as UserController).get(request, response);
  }
}
