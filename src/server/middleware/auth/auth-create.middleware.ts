...
export class AuthCreateMiddleware extends MiddlewareBase {
  ...
  public apply(request: Request<{}, UserCreation, UserCreation, ParsedQs, Record<string, any>>, response: Response<any, Record<string, any>, number>, next: any) {
    (this.controllerManagerService.getPrimaryController(AuthControllerName) as AuthController).create(request, response);
  }
}
