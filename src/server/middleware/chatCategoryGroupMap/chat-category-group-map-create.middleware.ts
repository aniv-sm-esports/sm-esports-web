...
import {ChatCategoryControllerName, ChatCategoryGroupMapControllerName} from '../../service/controller-const';
...
export class ChatCategoryGroupMapCreateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatCategoryGroupMap>, ApiRequest<ChatCategoryGroupMap>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatCategoryGroupMapControllerName) as ChatCategoryGroupMapController).create(request, response);
  }
}
