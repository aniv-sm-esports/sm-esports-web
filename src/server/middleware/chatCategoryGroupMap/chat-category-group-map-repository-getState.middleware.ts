...
export class ChatCategoryGroupMapRepositoryGetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatCategoryGroupMap>, ApiRequest<ChatCategoryGroupMap>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatCategoryGroupMapControllerName) as ChatCategoryGroupMapController).getState(request, response);
  }
}
