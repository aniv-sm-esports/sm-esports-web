...
export class ChatCategoryRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatCategory>, ApiRequest<ChatCategory>, ParsedQs, Record<string, any>>,
    ...
    //(this.controllerManagerService.getPrimaryController(ChatCategoryControllerName) as ChatCategoryController).setState(request, response);
  }
}
