...
export class FileGetAllMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<FileModel>, ApiRequest<FileModel>, ParsedQs, Record<string, any>>,
                        response: Response<ApiResponse<FileModel>, Record<string, any>, number>, next: any) {
    (this.controllerManagerService.getPrimaryController(FileControllerName) as FileController).getAll(request, response);
  }
}
