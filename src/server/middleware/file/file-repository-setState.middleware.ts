...
export class FileRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public apply(request: Request<{}, ApiResponse<FileModel>, ApiRequest<FileModel>, ParsedQs, Record<string, any>>, response: Response<any, Record<string, any>, number>, next: any) {
    //(this.controllerManagerService.getPrimaryController(FileControllerName) as FileController).setState(request, response);
  }
}
