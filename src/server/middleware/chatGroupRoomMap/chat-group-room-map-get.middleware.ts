...
export class ChatGroupRoomMapGetMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroupRoomMap>, ApiRequest<ChatGroupRoomMap>, ParsedQs, Record<string, any>>,
    ...
    (this.controllerManagerService.getPrimaryController(ChatGroupRoomMapControllerName) as ChatGroupRoomMapController).get(request, response);
  }
}
