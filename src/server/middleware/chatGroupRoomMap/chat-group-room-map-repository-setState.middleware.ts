...
import {ChatGroupRoomMapControllerName} from '../../service/controller-const';
import {ChatGroupRoomMapController} from '../../controller/chat-group-room-map.controller';

export class ChatGroupRoomMapRepositorySetStateMiddleware extends MiddlewareBase {
  ...
  public override apply(request: Request<{}, ApiResponse<ChatGroupRoomMap>, ApiRequest<ChatGroupRoomMap>, ParsedQs, Record<string, any>>,
    ...
    //(this.controllerManagerService.getPrimaryController(ChatGroupRoomMapControllerName) as ChatGroupRoomMapController).setState(request, response);
  }
}
