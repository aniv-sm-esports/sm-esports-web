...
exports.PersonRoleType = exports.PersonRoleTypeEnum = void 0;
var sequelize_typescript_1 = require("sequelize-typescript");
var Entity_1 = require("./Entity");
var PersonRoleTypeEnum;
(function (PersonRoleTypeEnum) {
    PersonRoleTypeEnum[PersonRoleTypeEnum["GeneralUser"] = 0] = "GeneralUser";
    PersonRoleTypeEnum[PersonRoleTypeEnum["BoardMember"] = 1] = "BoardMember";
})(PersonRoleTypeEnum || (exports.PersonRoleTypeEnum = PersonRoleTypeEnum = {}));
var PersonRoleType = function () {
    ...
    var PersonRoleType = _classThis = /** @class */ (function (_super) {
        __extends(PersonRoleType_1, _super);
        function PersonRoleType_1() {
        ...
        PersonRoleType_1.prototype.ctor = function () {
            return new PersonRoleType();
        };
        Object.defineProperty(PersonRoleType_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(PersonRoleType_1.prototype, "Name", {
            get: function () { return this.getDataValue('Name'); },
            set: function (value) { this.setDataValue('Name', value); },
            enumerable: false,
            configurable: true
        });
        return PersonRoleType_1;
    }(_classSuper));
    __setFunctionName(_classThis, "PersonRoleType");
    (function () {
        var _a;
        ...
        PersonRoleType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PersonRoleType = _classThis;
}();
exports.PersonRoleType = PersonRoleType;
