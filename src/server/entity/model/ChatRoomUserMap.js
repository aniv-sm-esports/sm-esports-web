...
exports.ChatRoomUserMap = void 0;
var sequelize_typescript_1 = require("sequelize-typescript");
var Entity_1 = require("./Entity");
var ChatRoomUserMap = function () {
    ...
    var ChatRoomUserMap = _classThis = /** @class */ (function (_super) {
        __extends(ChatRoomUserMap_1, _super);
        function ChatRoomUserMap_1() {
            var _this = _super.call(this) || this;
            __runInitializers(_this, _instanceExtraInitializers);
            return _this;
        }
        ChatRoomUserMap_1.prototype.ctor = function () {
            return new ChatRoomUserMap();
        };
        Object.defineProperty(ChatRoomUserMap_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatRoomUserMap_1.prototype, "ChatRoomId", {
            get: function () { return this.getDataValue('ChatRoomId'); },
            set: function (value) { this.setDataValue('ChatRoomId', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatRoomUserMap_1.prototype, "UserId", {
            get: function () { return this.getDataValue('UserId'); },
            set: function (value) { this.setDataValue('UserId', value); },
            enumerable: false,
            configurable: true
        });
        return ChatRoomUserMap_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ChatRoomUserMap");
    (function () {
        var _a;
        ...
        ChatRoomUserMap = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ChatRoomUserMap = _classThis;
}();
exports.ChatRoomUserMap = ChatRoomUserMap;
