...
var File = function () {
    ...
    var _get_Path_decorators;
    var File = _classThis = /** @class */ (function (_super) {
        __extends(File_1, _super);
        function File_1() {
            var _this = _super.call(this) || this;
            __runInitializers(_this, _instanceExtraInitializers);
            return _this;
        }
        File_1.prototype.ctor = function () {
            return new File();
        };
        Object.defineProperty(File_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(File_1.prototype, "Name", {
            get: function () { return this.getDataValue('Name'); },
            set: function (value) { this.setDataValue('Name', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(File_1.prototype, "Path", {
            get: function () { return this.getDataValue('Path'); },
            set: function (value) { this.setDataValue('Path', value); },
            enumerable: false,
            configurable: true
        });
        return File_1;
    }(_classSuper));
    __setFunctionName(_classThis, "File");
    (function () {
        var _a;
        ...
        _get_Path_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.STRING,
                allowNull: false,
            })];
        ...
        __esDecorate(_classThis, null, _get_Path_decorators, { kind: "getter", name: "Path", static: false, private: false, access: { has: function (obj) { return "Path" in obj; }, get: function (obj) { return obj.Path; } }, metadata: _metadata }, null, _instanceExtraInitializers);
