...
exports.ChatRoomChatMap = void 0;
var sequelize_typescript_1 = require("sequelize-typescript");
var Entity_1 = require("./Entity");
var ChatRoomChatMap = function () {
    ...
    var _get_ChatId_decorators;
    var ChatRoomChatMap = _classThis = /** @class */ (function (_super) {
        __extends(ChatRoomChatMap_1, _super);
        function ChatRoomChatMap_1() {
            var _this = _super.call(this) || this;
            __runInitializers(_this, _instanceExtraInitializers);
            return _this;
        }
        ChatRoomChatMap_1.prototype.ctor = function () {
            return new ChatRoomChatMap();
        };
        Object.defineProperty(ChatRoomChatMap_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatRoomChatMap_1.prototype, "ChatRoomId", {
            get: function () { return this.getDataValue('ChatRoomId'); },
            set: function (value) { this.setDataValue('ChatRoomId', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatRoomChatMap_1.prototype, "ChatId", {
            get: function () { return this.getDataValue('ChatId'); },
            set: function (value) { this.setDataValue('ChatId', value); },
            enumerable: false,
            configurable: true
        });
        return ChatRoomChatMap_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ChatRoomChatMap");
    (function () {
        var _a;
        ...
        _get_ChatId_decorators = [(0, sequelize_typescript_1.Column)({
                type: sequelize_typescript_1.DataType.INTEGER,
                allowNull: false,
            })];
        ...
        __esDecorate(_classThis, null, _get_ChatId_decorators, { kind: "getter", name: "ChatId", static: false, private: false, access: { has: function (obj) { return "ChatId" in obj; }, get: function (obj) { return obj.ChatId; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ChatRoomChatMap = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ChatRoomChatMap = _classThis;
}();
exports.ChatRoomChatMap = ChatRoomChatMap;
