...
var ChatGroup = function () {
    ...
    var ChatGroup = _classThis = /** @class */ (function (_super) {
        __extends(ChatGroup_1, _super);
        function ChatGroup_1() {
        ...
        ChatGroup_1.prototype.ctor = function () {
            return new ChatGroup();
        };
        Object.defineProperty(ChatGroup_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatGroup_1.prototype, "Name", {
            get: function () { return this.getDataValue('Name'); },
            set: function (value) { this.setDataValue('Name', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ChatGroup_1.prototype, "Description", {
    ...
    __setFunctionName(_classThis, "ChatGroup");
    (function () {
        var _a;
        ...
        ChatGroup = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ChatGroup = _classThis;
}();
