...
exports.ArticleBannerLinkType = exports.ArticleBannerLinkTypeEnum = void 0;
var sequelize_typescript_1 = require("sequelize-typescript");
var Entity_1 = require("./Entity");
var ArticleBannerLinkTypeEnum;
(function (ArticleBannerLinkTypeEnum) {
    ArticleBannerLinkTypeEnum[ArticleBannerLinkTypeEnum["None"] = 0] = "None";
    ArticleBannerLinkTypeEnum[ArticleBannerLinkTypeEnum["Image"] = 1] = "Image";
    ArticleBannerLinkTypeEnum[ArticleBannerLinkTypeEnum["YoutubeVideo"] = 2] = "YoutubeVideo";
})(ArticleBannerLinkTypeEnum || (exports.ArticleBannerLinkTypeEnum = ArticleBannerLinkTypeEnum = {}));
var ArticleBannerLinkType = function () {
    ...
    var ArticleBannerLinkType = _classThis = /** @class */ (function (_super) {
        __extends(ArticleBannerLinkType_1, _super);
        function ArticleBannerLinkType_1() {
        ...
        ArticleBannerLinkType_1.prototype.ctor = function () {
            return new ArticleBannerLinkType();
        };
        Object.defineProperty(ArticleBannerLinkType_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(ArticleBannerLinkType_1.prototype, "Name", {
            get: function () { return this.getDataValue('Name'); },
            set: function (value) { this.setDataValue('Name', value); },
            enumerable: false,
            configurable: true
        });
        return ArticleBannerLinkType_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ArticleBannerLinkType");
    (function () {
        var _a;
        ...
        ArticleBannerLinkType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ArticleBannerLinkType = _classThis;
}();
exports.ArticleBannerLinkType = ArticleBannerLinkType;
