...
var UserRoleType = function () {
    ...
    var UserRoleType = _classThis = /** @class */ (function (_super) {
        __extends(UserRoleType_1, _super);
        function UserRoleType_1() {
        ...
        UserRoleType_1.prototype.ctor = function () {
            return new UserRoleType();
        };
        Object.defineProperty(UserRoleType_1.prototype, "Id", {
            get: function () { return this.getDataValue('Id'); },
            set: function (value) { this.setDataValue('Id', value); },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(UserRoleType_1.prototype, "Name", {
            get: function () { return this.getDataValue('Name'); },
            set: function (value) { this.setDataValue('Name', value); },
            enumerable: false,
            configurable: true
        });
        return UserRoleType_1;
    }(_classSuper));
    __setFunctionName(_classThis, "UserRoleType");
    (function () {
        var _a;
        ...
        UserRoleType = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UserRoleType = _classThis;
}();
